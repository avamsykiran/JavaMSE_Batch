...
import com.bta.txns.entities.Txn;
import com.bta.txns.entities.TxnType;
import com.bta.txns.exceptions.AccountHolderException;
import com.bta.txns.exceptions.TxnException;
import com.bta.txns.repos.AccountHolderRepo;
import com.bta.txns.repos.TxnRepo;
...
public class TxnServiceImpl implements TxnService {
	...
	@Autowired
	private AccountsClient profiles;
	...
	public Txn add(Txn txn) throws AccountHolderException, TxnException {
		...
		ah.setCurrentBalance(
				txn.getType() == TxnType.CREDIT ? cb + txn.getAmount() : cb - txn.getAmount()
		);
		txn.setHolder(ah);
		ahRepo.save(ah);
