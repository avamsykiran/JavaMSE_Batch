...
public class AccountHolderServiceImpl implements AccountHolderService{
	...
	@Override
	public AccountHolder update(AccountHolder ah) throws AccountHolderException {
		if(!ahRepo.existsById(ah.getAhId())) {
			throw new AccountHolderException("No such record found");
		}		
	...
	@Override
	public void deleteById(Long ahId) throws AccountHolderException {
