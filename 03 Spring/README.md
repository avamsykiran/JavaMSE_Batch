...
-----------------------------------------------------------------------------------
    ...
    Introduction
        ...
        Spring Modules
            ...
            Spring Cloud        offers infra-structure support for microservices
            ...et.,
...
-------------------------------------------------------
    ...
    Spring Offers two Containers to take care of dependency injection.
        ...
        --------------------------------------------------------------
        LazyLoading                         EagerLoading - singleton-beans are created at the appStartUp

        no built-in Internationalization or built-in Internationalization, AOP integration ..etc.,
        AOP integration    

        BeanPostProcessors and              BeanPostProcessors and 
        BeanFactoryPostProcessors are to be BeanFactoryPostProcessors are registered automatically
        regsitered manually

        no Event Propagation support        built-in support to publish or listen to events

    BeanPostProcessors and BeanFactoryPostProcessors are to execute any task just after completing
    ...
    Bean Configuration
        ...
        Annotation Based Configuration
            ...
            @Component("id")        //this id is optional, the camelcase classNaem will be the default
                |
                |<- @Repository("id") 
                |<- @Service("id") 
                |<- @Controller("id") 
        ...
        Java Based Config
            ...
            class BeanConfig {
                ...
                @Bean                
                Scanner scan(){     //method name will be the bean-id
...
--------------------------------------------
    ...
    To Create a spring boot application / spring-starter-project
        ...
        (c) using STS, VSCode with SpringBoot Plugin.
...
------------------------------------------------------------------------
    ...
    YAML is a alternate format for .properties file
