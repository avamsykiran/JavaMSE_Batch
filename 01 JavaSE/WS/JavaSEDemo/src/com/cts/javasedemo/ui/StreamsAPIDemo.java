...
public class StreamsAPIDemo {
	public static void main(String a[]) {
		...
		System.out.println("-----------------------------------------------------------------");
		List<List<String>> nestedListOfSkills =
		emps.stream()
			.map(e -> e.getSkills())
			.collect(Collectors.toList());
		
		System.out.println(nestedListOfSkills);
		
		System.out.println("-----------------------------------------------------------------");
		List<String> listOfSkills = 
				nestedListOfSkills.stream()
				.flatMap(List::stream)
				.collect(Collectors.toList());
		...
		System.out.println("-----------------------------------------------------------------");
		List<String> distinctListOfSkills = 
				nestedListOfSkills.stream()
				.flatMap(List::stream)
				.distinct()
				.collect(Collectors.toList());
		
		System.out.println(distinctListOfSkills);
